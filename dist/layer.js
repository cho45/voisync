export class LayersRenderer {
    ...
    layersData;
    mouthMapping;
    constructor(layersData, imageCache, mouthMapping) {
     ...
     */
    async renderWithMouthShapes(canvas, layerPaths, mouthShapes) {
        // 口レイヤーを展開
     ...
     * 必要な画像のファイルパスを取得
     */
    getRequiredImagePaths(layerPaths) {
     ...
     */
    expandLayersWithMouthShapes(layerPaths, mouthShapes) {
